...
func InitializeApp(ctx context.Context) (*http.Server, *ReportProcessor, error) {
	...
	v := handlers(todoHandler, greetHandler, authHandler, authMeHandler, authLogoutHandler, reportUploadHandler, reportListHandler, reportDownloadHandler, reportDeleteHandler, transactionsListHandler, categoriesHandler, categoryHandler, categoryRulesHandler, categoryRuleHandler, transactionCategoryHandler)
